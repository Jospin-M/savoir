...
export default function Sidebar() {
    // max character count for the bio (including spaces) should be 230 - reinforce this on the database
    // editing the profile in any way refresh the page so 
    // that updated data is shown when the user completes the action
    ...
    // create modal overlay to edit (cover photo, name, profile pic,
    // bio, and languages)
    // also, don't forget to add button to edit profile 
    return ((
